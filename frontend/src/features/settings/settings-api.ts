...
export type SettingsConfigDTO = {
  ...
  providerWeb: {
    ...
    clearanceMode: ClearanceMode; clearanceSolver: ClearanceSolver; flareSolverrURL: string; clearanceSolverURL: string; clearanceSolverKey: string; clearanceTimeout: string; clearanceRefresh: string;
...
const settingsConfigValidator = hasShape({
  ...
  providerWeb: hasShape({
    ...
    statsigSignerURL: isString, clearanceMode: isOneOf("manual", "flaresolverr", "on_demand"), clearanceSolver: isOneOf("flaresolverr", "cf-clearance-scraper"), flareSolverrURL: isString, clearanceSolverURL: isString, clearanceSolverKey: isString,
